<%-- 
    Document   : newEmp
    Created on : Jun 26, 2016, 9:22:43 AM
    Author     : lenovo
--%>
      ...
      if(!rs.next()){
          ...
          %> 
              ...
              <div class="content_left">
                  ...
                  <ul>
                      <li><a href="manager.jsp" >Your Payroll</a></li>
                      <li><a href="newEmp.jsp" class="current">New Employee</a></li>
                  ...
                  <h4>   
<form action="newEmp.jsp" method="POST">
            Name:
            ...
            <textarea id="add" name="add" cols="30" rows="5"></textarea><br>
            ...
            <label id="sal" >Basic Salary: </label>
